...
import xiaoyf.demo.kafka.topology.selfjoin.streamstream.SelfStreamJoinTopology;
...
@ContextConfiguration(
    classes = {
        ...
        SelfStreamJoinTopologyTest.TestConfig.class,
        SelfStreamJoinTopology.class,
        PreferenceSelfJoiner.class,
    }
)
@TestPropertySource(
        properties = {"demo-streams.stream-stream-self-join-app-enabled=true"}
)
@Slf4j
public class SelfStreamJoinTopologyTest {

    @Autowired
    @Qualifier("streamStreamSelfJoinStreamBuilder")
    private StreamsBuilder streamStreamSelfJoinStreamBuilder;
    ...
    @BeforeEach
    void setup() {
        helper = new TopologyTestHelper(streamStreamSelfJoinStreamBuilder);
    ...
    void shouldRaiseGreenChangeWithTableJoin() {
        ...
        assertThat(prefChange).hasSize(4);
        assertThat(prefChange).satisfiesOnlyOnce(
    ...
    static class TestConfig {
        ...
        StreamsBuilder streamStreamSelfJoinStreamBuilder() {
        ...
        DemoProperties demoProperties() {
            ...
            properties.setStreamStreamSelfJoinAppId("self-stream-join-topology-test");
