...
public class StreamMergeProcessor {
    ...
    private void merge1(final StreamsBuilder builder) {
        ...
        KStream<String, String> stream1 = builder.stream(STREAM1_TOPIC);
        KStream<String, String> stream2 = builder.stream(STREAM2_TOPIC);

        stream1
                .mapValues(v -> v + ".added")
                .to(STREAM_MERGED_TOPIC);
        stream2
                .mapValues(v -> v + ".added")
                .to(STREAM_MERGED_TOPIC);
    ...
    private void merge2(final StreamsBuilder builder) {
        ...
        KStream<String, String> stream1 = builder.<String, String>stream(STREAM1_TOPIC).mapValues(v -> v + ".added");
        KStream<String, String> stream2 = builder.<String, String>stream(STREAM2_TOPIC).mapValues(v -> v + ".added");
    ...
    public static void main(String[] args) {
        ...
        StreamMergeProcessor p = new StreamMergeProcessor();
        p.process(b);
