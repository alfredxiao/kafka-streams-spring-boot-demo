...
import static xiaoyf.demo.kafka.topology.fklookup.byregularstore.CustomerStoreProcessor.CUSTOMER_STORE;

/**
 * FkLookupProcessor applies generic foreign key lookup using a regular store.
 */
@Slf4j
