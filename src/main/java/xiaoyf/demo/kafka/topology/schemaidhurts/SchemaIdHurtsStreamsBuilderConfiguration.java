...
public class SchemaIdHurtsStreamsBuilderConfiguration {

    private final DemoProperties properties;
    @Bean("schemaIdHurtsStreamsBuilder")
    public StreamsBuilderFactoryBean schemaIdHurtsStreamsBuilder(KafkaProperties props) {

        Map<String, Object> config = props.buildStreamsProperties(null);
        config.put(StreamsConfig.APPLICATION_ID_CONFIG, properties.getSchemaIdHurtsAppId());
